...
1. **"From an app manifest"** を選択します。
1. アプリをインストールするワークスペースを選択します。
1. 以下の Manifest (YAML) をコピーして貼り付けます。
...
1. 表示された URL を Slack API コンソールの `Request URL` に入力。
1. `Verified` と表示されれば接続成功です。
